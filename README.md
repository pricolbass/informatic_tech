# Домашние задания и контрольные МОАИСа по информационным технологиям за 1-2 семестр.
  <ul> 
    ...
    <li>КР по коллекциям и работой с памятью на Яндекс LMS (<a href='https://github.com/pricolbass/informatic_tech/blob/main/2_sem/ITP/Yandex_TP/lms_3.6-3.md'>3 подгруппа</a>)</li>
